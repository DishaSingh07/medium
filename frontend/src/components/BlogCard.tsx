...
// }: BlogCardProps) => {
//     return <div className="p-4 border-b pb-4 border-slate-200">
//         <div className="flex">
...
//             {content.slice(0, 100) + "..."}
//         </div>
//         <div className="text-slate-5 00 text-sm font-thin pt-4">
...
//     return <div className={`relative inline-flex items-center ${size === "small" ? "w-6 h-6" : "w-10 h-10"} justify-center w-${size} h-${size}   overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600`}>
